                ...
                ${data.category?.availability === "0" ? `
                    <div class="discontinued-overlay">
                        <div class="discontinued-message">
                            <div class="discontinued-icon-wrapper">
                                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M12 9V13M12 17H12.01M21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                            </div>
                            <div class="discontinued-text">
                                <h3 class="discontinued-title">Service Unavailable</h3>
                                <p class="discontinued-subtitle">This service has been discontinued</p>
                            </div>
                        </div>
                    </div>
                ` : ''}
